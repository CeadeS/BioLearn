...
class GradientReconstructor():
    ...
    def reconstruct(self, input_data, labels, img_shape=(3, 32, 32), dryrun=False, eval=True, tol=None, verbose=False):
        ...
        if self.config['scoring_choice'] in ['pixelmean', 'pixelmedian']:
            ...
            if verbose: print('Choosing optimal result ...')
    ...
    def _gradient_closure(self, optimizer, x_trial, input_gradient, label):
        ...
        def closure():
            ...
            #gradient = torch.autograd.grad(loss, parameters, create_graph=False, allow_unused=True)
        ...
        for i in indices:
            ...
            if cost_fn == 'l2':
                ...
                try:
                    ...
                    print(len(trial_gradient), len(input_gradient))
                    pass
