...
from bio_transformations.bio_converter import BioConverter as bc
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_channels=3, num_classes=10):
        ...
        self.conv1 = nn.Conv2d(num_channels, int(base_channels / 10 * num_classes), kernel_size=3, stride=1, padding=1,
                               bias=False)
        ...
        self.linear = bc.mark_skip_weight_splitting(nn.Linear(int(base_channels / 10 * num_classes * 4), num_classes))
...
def resnet20(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [3, 3, 3], "num_channels": num_channels,
                    "num_classes": num_classes}


def resnet32(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [5, 5, 5], "num_channels": num_channels,
                    "num_classes": num_classes}


def resnet44(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [7, 7, 7], "num_channels": num_channels,
                    "num_classes": num_classes}


def resnet56(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [9, 9, 9], "num_channels": num_channels,
                    "num_classes": num_classes}


def resnet110(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [18, 18, 18], "num_channels": num_channels,
                    "num_classes": num_classes}


def resnet1202(num_channels=3, num_classes=10):
    return ResNet, {"block": BasicBlock, "num_blocks": [200, 200, 200], "num_channels": num_channels,
                    "num_classes": num_classes}
