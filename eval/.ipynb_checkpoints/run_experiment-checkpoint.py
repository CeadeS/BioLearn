from pytorch_bio_transformations.experiment import run_sequencial, run_whole
from pytorch_bio_transformations.modules.linear import FCNet
from pytorch_bio_transformations.modules.alexnetMini import AlexNetMini
from pytorch_bio_transformations.modules.resnetMini import resnet20,resnet32,resnet44,resnet56,resnet110,resnet1202
import torch
import numpy as np
